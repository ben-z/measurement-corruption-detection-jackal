...
for vel_bias in $(loop_with_step -2.0 2.0 0.25); do
    __exp_name_prefix="circle-odom-angvel-corruption-$vel_bias"
    ...
    generate_tembo_scenario \
        ...
        corruption /jackal_velocity_controller/odom/corruption nav_msgs/Odometry angular_vel_z step $vel_bias \
    >> $__commands_file
done
