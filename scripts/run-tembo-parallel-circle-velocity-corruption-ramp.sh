...
for vel_ramp in $(loop_with_step -2.0 2.0 0.2); do
    __exp_name_prefix="circle-velocity-corruption-ramp-$vel_ramp"
    ...
    generate_tembo_scenario \
        ...
        corruption /jackal_velocity_controller/odom/corruption nav_msgs/Odometry linear_vel_x ramp $vel_ramp \
    >> $__commands_file
done
