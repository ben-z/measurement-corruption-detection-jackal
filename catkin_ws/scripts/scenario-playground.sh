...
rosrun bcontrol corruption_generator.py /global_localization/robot/odom/corruption nav_msgs/Odometry orientation step $__bias_magnitude __name:=my_corruption_generator 2>&1 | ts | tee "$EXPERIMENT_DIR"/ros-corruption-generator.log &
sleep_simtime 15
